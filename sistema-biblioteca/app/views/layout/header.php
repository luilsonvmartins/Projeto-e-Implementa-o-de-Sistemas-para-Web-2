...
<head>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .navbar-nav a:hover,.navbar-nav a.active{background:#2E6DA4;color:#fff;text-decoration:none}
        ...
        .form-control{width:100%;padding:.5rem .75rem;border:1px solid #d1d5db;border-radius:5px;font-size:.9rem}
